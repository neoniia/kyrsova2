...
export function initSearch() {
  ...
  // Обробка введення тексту - пошук відбувається при введенні кожної літери
  searchInput.addEventListener('input', () => {
    ...
    // Встановлюємо мінімальну затримку (150ms) для оптимізації кількості запитів
